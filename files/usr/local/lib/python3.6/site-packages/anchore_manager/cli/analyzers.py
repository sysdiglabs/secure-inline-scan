...
@analyzers.command()
@click.argument('oci-dir', type=click.Path(exists=True))
...
def exec(oci_dir, anchore_archive, digest, parent_digest, image_id, tag, account_id, manifest, dockerfile, created_at, annotation):
    """
    ...
    try:
        ...
        # perform analysis
        image_data, analyzed_manifest_data = analyze_image(oci_dir, userId, rawmanifest, image_record, workspace_root, config, registry_creds=[], use_cache_dir=None)
