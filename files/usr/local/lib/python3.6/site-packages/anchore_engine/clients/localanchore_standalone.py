...
def analyze_image(oci_image_path, userId, manifest, image_record, tmprootdir, localconfig, registry_creds=[], use_cache_dir=None, parent_manifest=None):
    # need all this
    ...
    try:
        ...
        # Image is expected in OCI image format, in oci_imgae_path folder, so just symlink it
        os.rmdir(staging_dirs['copydir'])
        os.symlink(oci_image_path, staging_dirs['copydir'])
